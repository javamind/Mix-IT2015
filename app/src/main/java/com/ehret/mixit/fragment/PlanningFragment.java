    ...
    protected class PlanningPagerAdapter extends PagerAdapter {
        ...
        protected void dessinerCalendrierJour0(TableLayout planningHoraireTableLayout) {
            planningJourneyBuilderJour0
                    ...
                    .addViewWorkshop(24, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(29, 10, 0))
                    ...
                    .addViewWorkshop(54, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(29, 12, 30))
                    ...
                    .addViewWorkshop(82, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(29, 14, 50))
        ...
        protected void dessinerCalendrierJour1(TableLayout planningHoraireTableLayout) {
            planningJourneyBuilderJour1
                    ...
                    .addViewWorkshop(24, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(30, 10, 0))
                    ...
                    .addViewWorkshop(54, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(30, 12, 30))
                    ...
                    .addViewWorkshop(82, 24, getResources().getString(R.string.calendrier_atelier), false, R.drawable.button_workshop_background, UIUtils.createPlageHoraire(30, 14, 50))
